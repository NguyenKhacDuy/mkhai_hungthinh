<template>
  <div class="container-approved">
    <div class="select-options">
      <el-form>
        <el-form-item label="Tìm kiếm theo">
          <el-select
            v-model="option"
          ...
          >
            ...
            <el-option label="Đã xử lý" value="completed"></el-option>
          </el-select>
        </el-form-item>
      </el-form>
    </div>
    <el-table :data="arrLicense" style="width: 100%">
      ...
      <el-table-column prop="status" label="Trạng thái">
        <template slot-scope="scope">
          ...
          <el-tag v-if="scope.row.status === 1" type="success">Chờ chi</el-tag>
...
export default {
  ...
  created() {
    this.option = "approved";
    this.getLicenseApproved();
  },
  methods: {
